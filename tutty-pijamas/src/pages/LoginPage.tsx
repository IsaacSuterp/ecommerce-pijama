      ...
      <div className="w-full max-w-md">
        ...
        >
          <div className="text-center">
            <h1 className="text-4xl font-serif text-graphite">Acessar sua Conta</h1>
          ...
          <form className="mt-8 space-y-6">
            ...
            <div className="text-right text-sm">
              <a href="#" className="font-medium text-soft-gold hover:text-soft-gold/80">
                Esqueceu sua senha?
              </a>
            </div>
          ...
          <p className="mt-6 text-center text-sm text-gray-600">
            ...
            <Link to="/cadastro" className="font-medium text-soft-gold hover:text-soft-gold/80">
              Cadastre-se
            </Link>
          </p>
        </motion.div>
